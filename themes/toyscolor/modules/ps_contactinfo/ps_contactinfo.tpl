...
<div class="block-contact col-md-4 links wrapper">
  ...
  <p class="h4 block-contact-title hidden-sm-down">{l s='Contact' d='Shop.Theme.Global'}</p>
  <div id="contact-infos" class="collapse">
    <p>{$contact_infos.address.address1 nofilter}</p>
    <p>{$contact_infos.address.postcode nofilter} {$contact_infos.address.city nofilter}</p>
    ...
    {if $contact_infos.details}
      <p>{l s='Siret : ' d='Shop.Theme.Global'} {$contact_infos.details}</p>
    {/if}
  </div>
</div>
